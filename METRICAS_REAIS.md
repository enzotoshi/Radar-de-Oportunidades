...
|---|---|---|---|---|
| Endereço e coordenadas | REAL | Photon ou Nominatim/OpenStreetMap | momento da busca | WGS84 |
...
- Sugestões Photon e geocodificação Nominatim: 30 dias, pois endereços e coordenadas mudam lentamente.

...
# Desabilita avisos de SSL quando verificação está desligada
urllib3.disable_warnings(urllib3.exceptions.InsecureRequestWarning)

# Desabilita verificação SSL em ambientes corporativos/escolares onde certificados bloqueiam APIs públicas
...
_session.verify = not DISABLE_SSL_VERIFY
_cache: Dict[str, Tuple[float, Any]] = {}
OSM_CACHE_SECONDS = 30 * 60  # Cache de 30 minutos para reduzir consultas repetidas
...
BUSINESS_FILTERS: Dict[str, List[Tuple[str, str]]] = {
    ...
    "restaurante_fitness": [("amenity", "restaurant"), ("cuisine", "healthy|vegetarian|vegan|salad")],
    "hamburgueria": [("amenity", "fast_food|restaurant"), ("cuisine", "burger|american")],
    "pizzaria": [("amenity", "restaurant|fast_food"), ("cuisine", "pizza|italian")],
    "restaurante_japones": [("amenity", "restaurant"), ("cuisine", "japanese|sushi|asian")],
    "padaria": [("shop", "bakery")],
    "confeitaria": [("shop", "bakery|pastry|confectionery|chocolate")],
    "bar_pub": [("amenity", "bar|pub|nightclub")],
    "delivery_comida": [("amenity", "restaurant|fast_food")],
    
    # Saúde e bem-estar
    "academia": [("leisure", "fitness_centre|sports_centre|fitness_station"), ("amenity", "gym")],
    "farmacia": [("amenity", "pharmacy")],
    "clinica_odontologica": [("amenity", "dentist")],
    "clinica_medica": [("amenity", "clinic|doctors|hospital")],
    "clinica_estetica": [("shop", "beauty|cosmetics"), ("amenity", "clinic")],
    "pilates_yoga": [("leisure", "fitness_centre|sports_centre"), ("sport", "yoga|pilates|fitness")],
    
    # Varejo
    "loja_roupas": [("shop", "clothes|fashion|boutique")],
    "loja_calcados": [("shop", "shoes")],
    "loja_eletronicos": [("shop", "electronics|mobile_phone|computer|hifi")],
    "loja_cosmeticos": [("shop", "cosmetics|perfumery|beauty|chemist")],
    "mercado": [("shop", "supermarket|convenience")],
    "mercado_organico": [("shop", "supermarket|convenience|greengrocer|organic")],
    "brecho": [("shop", "second_hand|charity|clothes")],
    "livraria_cafe": [("shop", "books|stationery"), ("amenity", "cafe|library")],
    "loja_moveis": [("shop", "furniture|interior_decoration|flooring|bed")],
    
    # Serviços
    "coworking": [("office", "coworking|yes"), ("amenity", "coworking_space")],
    "salao_beleza": [("shop", "hairdresser|beauty|cosmetics")],
    "barbearia": [("shop", "hairdresser|barber")],
    "pet_shop": [("shop", "pet|pet_grooming"), ("amenity", "veterinary|animal_shelter")],
    "lava_rapido": [("shop", "car_wash"), ("amenity", "car_wash")],
    "servicos_limpeza": [("shop", "cleaning|laundry|dry_cleaning")],
    "assistencia_tecnica": [("shop", "repair|electronics_repair|mobile_phone")],
    
    # Educação
    "escola_idiomas": [("amenity", "language_school|school|college")],
    "curso_profissionalizante": [("amenity", "college|training|school")],
    "curso_tecnologia": [("amenity", "college|training|school|university")],
    "escola_artes": [("amenity", "music_school|school|arts_centre"), ("craft", "arts|musical_instrument")],
    
    # Negócios e outros
    "hotel": [("tourism", "hotel|hostel|guest_house|motel")],
    "imobiliaria": [("office", "estate_agent|yes"), ("shop", "estate_agent")],
    "materiais_construcao": [("shop", "doityourself|hardware|trade|building_supplies")],
    "casa_jardim": [("shop", "garden_centre|houseware|hardware|florist")],
}
...
def _business_filters(business_type: str) -> List[Tuple[str, str]]:
    ...
    aliases = {
        ...
        "loja_de_calcados": "loja_calcados",
        "loja_de_cosmeticos": "loja_cosmeticos",
        "loja_de_moveis": "loja_moveis",
        "curso_de_tecnologia": "curso_tecnologia",
        "escola_de_artes": "escola_artes",
...
def _query_osm(lat: float, lng: float, business_type: str, radius: int) -> Dict[str, Any]:
    ...
    # Cria uma única query Overpass unindo todos os filtros com OR
    # Cada tupla (key, pattern) vira uma consulta separada unida no mesmo grupo
    lat_delta = radius / 111_320
    lng_delta = radius / (111_320 * max(0.1, math.cos(math.radians(lat))))
    south, north = lat - lat_delta, lat + lat_delta
    west, east = lng - lng_delta, lng + lng_delta
    ...
    for key, pattern in filters:
        competitor_selectors.append(f'nwr({south:.7f},{west:.7f},{north:.7f},{east:.7f})["{key}"~"^({pattern})$"];')
    
    competitor_query = "\n".join(competitor_selectors)
...
def search_locations(query: str, limit: int = 5) -> List[Dict[str, Any]]:
    ...
    for item in payload:
        ...
        # OTIMIZAÇÃO: código IBGE só é buscado durante a análise final, não no autocomplete
        # Isso remove latência desnecessária da busca de endereços
        municipality = None
        if city_name and state_code:
            municipality = {
                "ibge_code": "",  # Será preenchido na análise se necessário
                "name": city_name,
                "state": state_code,
            }
